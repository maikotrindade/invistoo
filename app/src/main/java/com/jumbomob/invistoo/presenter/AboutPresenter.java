...
public class AboutPresenter implements BasePresenter<AboutView> {
    ...
    public List<LicenseDTO> getLicenses() {
        ...
        licenses.add(new LicenseDTO("Retrofit", "2.0.0",
        ...
        licenses.add(new LicenseDTO("Support Design", "23.4.0",
        ...
        licenses.add(new LicenseDTO("FloatingActionButton", "2",
        ...
        licenses.add(new LicenseDTO("firebase-client-android", "2",
        ...
        licenses.add(new LicenseDTO("Material Spinner", "1.1.0",
